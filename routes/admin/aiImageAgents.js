...
const {
  serumBottleSecretless,
  runtimeToReviewV2Trial001,
  runtimeToReviewV2Trial002,
} = AI_IMAGE_SECRETLESS_TRIAL_FIXTURES;
const {
...
const AUTHORIZED_DOUBAO_PROJECT_BASE_PATH_OVERRIDES =
  AI_IMAGE_DOUBAO_PROJECT_BASE_PATH_OVERRIDES;
...
function validateRuntimeToReviewV2Trial002ExactBinding(body, routeInput, outputDirectoryRef) {
  ...
  if (promptPackageRef !== R2R_V2_TRIAL_002_EXACT_PROMPT_PACKAGE_REF) {
    mismatches.push({
      field: 'visual_job_contract.prompt_package_ref',
      expected: R2R_V2_TRIAL_002_EXACT_PROMPT_PACKAGE_REF,
...
function validateRuntimeToReviewV2Trial001ExactBinding(body, routeInput, outputDirectoryRef) {
  ...
  if (promptPackageRef !== R2R_V2_TRIAL_001_EXACT_PROMPT_PACKAGE_REF) {
    mismatches.push({
      field: 'visual_job_contract.prompt_package_ref',
      expected: R2R_V2_TRIAL_001_EXACT_PROMPT_PACKAGE_REF,
      received: promptPackageRef || null,
    });
  }
