...
当前里程碑：Jenn fork 内长期维护收口（M9 Agent taskbook ready；M8/S25 deferred）
...
| --- | --- | --- | --- |
| Agent | `VCP_AGENT_DIRS`、`VCP_AGENT_OVERRIDE_DIRS` | Jenn Agent 和 AgentOverrides | 任务书已写；下一步是 Agent copy-first gate，不自动复制。 |
