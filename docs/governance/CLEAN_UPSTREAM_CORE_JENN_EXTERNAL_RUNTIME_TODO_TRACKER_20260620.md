...
Progress: [##########] 98% (120.7 / 123 global milestone units; scope expanded by M122 PASS)

Last updated: 2026-06-22

当前里程碑：Agent additive resolver policy decision（M122 PASS；next recommended gate M123 aggregate gap / next-lane decision）
...
- 长期路线图：正式 milestone，从原始 M0-M8 到 Jenn fork maintenance overlay M9-M122；M96-PRE 是不计分前置子门。
- 短期执行记录：实际 sprint ledger，记录 S1-S48 与 S50-S144 已完成工作；S49 upstream PR gate deferred。
...
- 全局 Progress 覆盖 M0-M122 全路线，只保留这一种进度口径。
- 每个 milestone 记 1 个 global milestone unit；M0-M122 合计 123 units。
...
- M121 完成 Agent additive resolver policy taskbook；定义 core-precedence、external-precedence、namespace/alias、override-only、defer 五种政策选项与 M122 决策门；不改 AgentManager、不启 `VCP_AGENT_DIRS`、不写 env、不打印 prompt body。
- M122 完成 Agent additive resolver policy decision；选择 `A_KEEP_CORE_PRECEDENCE_AND_LEAVE_ADDITIVE_RUNTIME_OFF_NOW`；不改 AgentManager、不启 `VCP_AGENT_DIRS`、不写 env、不复制 Agent。
...
M0-M8 是原始 acceptance plan 阶段；M9-M122 是当前 Jenn fork 长期维护与本地稳定验收路线。两者共同计入顶部全局 Progress；原始 100 分仅作为历史验收拆分背景，不再单独维护进度。
...
| [x] | M121 | 0 | Agent additive resolver policy taskbook | PASS | `docs/governance/CLEAN_UPSTREAM_CORE_JENN_EXTERNAL_RUNTIME_M121_AGENT_ADDITIVE_RESOLVER_POLICY_TASKBOOK_20260622.md`；taskbook-only; defines resolver policy options and recommends `M122_AGENT_ADDITIVE_RESOLVER_POLICY_DECISION`; no AgentManager/env/runtime/private/prompt-body/upstream action。 |
| [x] | M122 | 0 | Agent additive resolver policy decision | PASS | `docs/governance/CLEAN_UPSTREAM_CORE_JENN_EXTERNAL_RUNTIME_M122_AGENT_ADDITIVE_RESOLVER_POLICY_DECISION_20260622.md`；decision-only; selected `A_KEEP_CORE_PRECEDENCE_AND_LEAVE_ADDITIVE_RUNTIME_OFF_NOW`; no AgentManager/env/runtime/private/prompt-body/core-fallback/upstream action。 |
...
M121 PASS：1.0 / 1 unit（Agent additive resolver policy taskbook；M122 policy decision recommended, no implementation）
M122 PASS：1.0 / 1 unit（Agent additive resolver policy decision；core-precedence retained, additive runtime off）
Global Progress：120.7 / 123 = 98.13%，顶部显示为 98%
```
...
| [x] | S143 | Agent / M121 | 0 | Agent additive resolver policy taskbook | PASS | `docs/governance/CLEAN_UPSTREAM_CORE_JENN_EXTERNAL_RUNTIME_M121_AGENT_ADDITIVE_RESOLVER_POLICY_TASKBOOK_20260622.md`；taskbook-only; resolver policy options and M122 decision gate defined; no AgentManager/env/runtime/private/prompt-body/upstream action。 |
| [x] | S144 | Agent / M122 | 0 | Agent additive resolver policy decision | PASS | `docs/governance/CLEAN_UPSTREAM_CORE_JENN_EXTERNAL_RUNTIME_M122_AGENT_ADDITIVE_RESOLVER_POLICY_DECISION_20260622.md`；decision-only; selected core-precedence retained/additive runtime off; no AgentManager/env/runtime/private/prompt-body/upstream action。 |
...
M121：Agent additive resolver policy taskbook PASS；定义 resolver policy options 和 M122 decision gate；不改 AgentManager、不启 `VCP_AGENT_DIRS`、不写真实 env、不打印 prompt body。
M122：Agent additive resolver policy decision PASS；选择 core-precedence retained / additive runtime off；不改 AgentManager、不启 `VCP_AGENT_DIRS`、不写真实 env、不复制 Agent。
```
...
| Agent additive resolver policy taskbook | M121 / S143 | define resolver policy choices for the M100 same-id additive blocker before any implementation | PASS；M122 policy decision recommended; no AgentManager/env/runtime/private/prompt-body action。 |
| Agent additive resolver policy decision | M122 / S144 | choose current resolver policy for the M100 same-id additive blocker | PASS；core precedence retained; additive runtime off; no AgentManager/env/runtime/private/prompt-body action。 |
...
| Agent additive resolver policy taskbook | M121 / S143 | define resolver policy options for the M100 same-id additive blocker without implementation | PASS；Progress `119.7 / 122`。 |
| Agent additive resolver policy decision | M122 / S144 | select core-precedence retained / additive runtime off without implementation | PASS；Progress `120.7 / 123`。 |
...
| Q104 | M121/S143 | PASS | Agent | `CLEAN_UPSTREAM_CORE_JENN_EXTERNAL_RUNTIME_M121_AGENT_ADDITIVE_RESOLVER_POLICY_TASKBOOK_20260622.md`；taskbook-only; resolver policy options and M122 decision gate defined; no AgentManager/env/runtime/private/prompt-body/upstream action。 |
| Q105 | M122/S144 | PASS | Agent | `CLEAN_UPSTREAM_CORE_JENN_EXTERNAL_RUNTIME_M122_AGENT_ADDITIVE_RESOLVER_POLICY_DECISION_20260622.md`；decision-only; selected core-precedence retained / additive runtime off; no AgentManager/env/runtime/private/prompt-body/upstream action。 |

### 5.5 M19-M122 + M96-PRE Specific Step Plan
...
| M121-01 | PASS | 复核 M100-M109/M120 Agent evidence by summary/path/name only | M100 BLOCK markers, M104 classification, M107/M109 closeout, M120 selected gate | 不打印 prompt body、不读取 private |
| M121-02 | PASS | 定义 resolver policy options and future validation/rollback | options A-E; recommended M122 decision gate | 不改 AgentManager、不启 `VCP_AGENT_DIRS` |
| M121-03 | PASS | 写 M121 taskbook 并更新 tracker：M121/S143/Q104 PASS | `docs/governance/CLEAN_UPSTREAM_CORE_JENN_EXTERNAL_RUNTIME_M121_AGENT_ADDITIVE_RESOLVER_POLICY_TASKBOOK_20260622.md`; Progress `119.7 / 122` | 不 commit/push、不打开 upstream PR |
| M122-01 | PASS | 复核 M121 policy options 与 M100/M107-M109 evidence | option A-E reviewed; M100 effective source remains `core:7` | 不改 resolver、不启 runtime |
| M122-02 | PASS | 选择当前 policy | `A_KEEP_CORE_PRECEDENCE_AND_LEAVE_ADDITIVE_RUNTIME_OFF_NOW` | 不写真实 env、不删 core fallback |
| M122-03 | PASS | 写 M122 decision 并更新 tracker：M122/S144/Q105 PASS | `docs/governance/CLEAN_UPSTREAM_CORE_JENN_EXTERNAL_RUNTIME_M122_AGENT_ADDITIVE_RESOLVER_POLICY_DECISION_20260622.md`; Progress `120.7 / 123` | 不 commit/push、不打开 upstream PR |
...
| Agent additive resolver policy taskbook | M121 taskbook；core-precedence, external-precedence, namespace/alias, override-only, and defer options defined; M122 policy decision recommended | PASS_TASKBOOK_ONLY；no AgentManager/env/source/runtime/private/prompt-body/upstream action |
| Agent additive resolver policy decision | M122 decision；selected core-precedence retained and additive runtime off | PASS_DECISION_ONLY；no AgentManager/env/source/runtime/private/prompt-body/upstream action |
