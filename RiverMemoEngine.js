...
class RiverMemoEngine {
    ...
    async _rerankNative(query, inputCandidates, agentContext, options, artifact, prepared) {
        ...
        return Object.freeze({
            // P1B treats unfamiliar schemas as unknown, rather than reporting
            // the old schema's hard-coded "contacts unavailable" limitation.
            schema: includeTrace
                ? 'rivermemo-topology-v3-causality-result-v1'
                : RESULT_SCHEMA,
            version: VERSION,
            ...
            queryId: queryState.queryId,
            ...(includeTrace ? {
                queryObservation: sourceObservation.causalityTrace || null,
                anchorQuery: nativeResult.anchorQuery || null
            } : {}),
