...
const { stripPassiveBlocks } = require("../../modules/passiveBlockUtils.js");
...
function stripControlPassiveBlocks(text) {
...
function resolveAgentIdentityFromText(text) {
  const content = stripControlPassiveBlocks(String(text || ""));
